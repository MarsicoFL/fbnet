...
#' It relies on a Bayesian Networks framework \doi{10.1017/CBO9780511811357}. It is particularly well suited
...
#' In particular, 'fbnet' imports the 'Familias' software
